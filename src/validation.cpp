...
#if defined(NDEBUG)
# error "Cheddar cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "Cheddar Signed Message:\n";
                              ...
                              bool fOverrideMempoolLimit, const CAmount& nAbsurdFee, std::vector<COutPoint>& coins_to_uncache)
{
...

    {
        ...
        {
            LogPrint(BCLog::MEMPOOL, "replacing tx %s with %s for %s CHDR additional fees, %d delta bytes\n",
