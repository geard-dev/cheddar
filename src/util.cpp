...
const char * const BITCOIN_CONF_FILENAME = "cheddar.conf";
const char * const BITCOIN_PID_FILENAME = "cheddar.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Cheddar";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Cheddar";
#else
    // Unix
    return pathRet / ".cheddar";
#endif
#endif
}
