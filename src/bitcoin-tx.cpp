...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s cheddar-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  cheddar-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded cheddar transaction") + "\n" +
              "  cheddar-tx [options] -create [commands]   " + _("Create hex-encoded cheddar transaction") + "\n" +
              "\n";
